...
<body>
    ...
    <div class="container">
        ...
        <div class="button-container">
            ...
            <button class="btn btn-insert" onclick="window.location='insert_bind_param.php'">
                Insertar datos (mysqli bind_param)
            </button>
            <button class="btn btn-insert" onclick="window.location='insert_pdo.php'">
                Insertar datos (PDO Seguro)
            </button>
            <button class="btn btn-create" onclick="window.location='select_bind_param.php'">
                Consultar datos (mysqli bind_param)
            </button>
            <button class="btn btn-update" onclick="window.location='update_table.php'">
                Actualizar datos (PDO)
            </button>
            <button class="btn btn-update" onclick="window.location='update_bind_param.php'">
                Actualizar datos (mysqli bind_param)
            </button>
            <button class="btn btn-update" onclick="window.location='update_pdo.php'">
                Actualizar datos (PDO Seguro)
            </button>
