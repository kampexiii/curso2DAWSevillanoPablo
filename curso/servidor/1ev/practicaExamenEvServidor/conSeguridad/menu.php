...
/*
 * Menu principal CRUD.
 * Cambia $dbDefault si en el examen te piden un nombre de BD concreto.
 * Si te dan un .sql, crea la BD con ese nombre, importalo (phpMyAdmin/CLI) y pulsa Conectar.
 */
$server = "localhost";
$user   = "root";
$pass   = "";
$dbDefault = "pruebas"; // cambia 'pruebas' por la BD que te pidan
...
if ($dbActiva) {
    try {
        ...
        if ($tablaExiste) {
            echo "<div class='info-box'>Tabla 'curso' disponible en '$dbActiva'</div>";
            ...
            if ($total > 0) {
                ...
                echo "<table>";
                echo "<tr>
                      <th>ID</th><th>Nombre</th><th>Apellidos</th><th>Email</th><th>Edad</th><th>Nota</th><th>Activo</th><th>Fecha Matricula</th>
                      </tr>";
            ...
            echo "La tabla 'curso' no existe en '$dbActiva'. Usa el boton CREAR TABLA.";
            echo "</div>";
        }
